package com.alura.api.challenge.suporte.validacao;
...
public class UniquenessValidator implements ConstraintValidator<Unique, Object> {
	...
	public boolean isValid(Object valueToBeValidated, ConstraintValidatorContext context) {
		...
		boolean existsInDB = entityManager.createQuery(jpql, Boolean.class).setParameter("value", valueToBeValidated)
				.getSingleResult();
